...
| Learner assembly | Ready for release packaging |
| Learner full Markdown | Ready for release packaging |
| Instructor companion | Ready for release packaging |
...
- Learner assembly links learner chapters only and does not include model answers or rubrics.
- Learner full Markdown concatenates learner-facing chapters and capstone only.
- Instructor companion links instructor guides and answer keys separately.
