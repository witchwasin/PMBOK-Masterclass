> **สถานะของไฟล์นี้:** เป็น **External Reference** ไม่ใช่ Canonical Source ของหลักสูตร (ดู [`docs/CONTENT-RULES.md`](../docs/CONTENT-RULES.md)) — เป็นเวอร์ชัน 2 ของ [`PMBOK-Aligned-End-to-End-Project-Delivery-Playbook.md`](PMBOK-Aligned-End-to-End-Project-Delivery-Playbook.md) (v1) เพิ่มชั้น Execution Ownership (RACI-style Accountable/Responsible ต่อกิจกรรม, Action Flow table ทุกช่วง A–H, Quick Role-to-Action Reference) ทำให้ actionable กว่า v1 — **ใช้ V2 เป็น preferred source, V1 เก็บไว้เพื่อ cross-check** อ้างอิง PMBOK® Guide 8th Edition เหมือน v1 ขณะที่บทเรียนหลักยังยึด PMBOK 6th+7th ตาม [`docs/PMBOK-EDITION-POSITION.md`](../docs/PMBOK-EDITION-POSITION.md)
>
> **การใช้งาน:** เป็นแหล่งอ้างอิงหลักของ [`field-guide/`](../field-guide) (PM Delivery Guide) — โครง workflow A–H ของเล่มนั้นมาจากไฟล์นี้
