...
แก่นสำคัญของ Agile Project Management: Mindset, Scrum and Kanban คือข้อใด?

A. ไม่มีแผน ไม่มีเอกสาร และเปลี่ยนงานได้ทุกวัน
B. ส่งมอบ value เป็นรอบสั้น เรียนรู้จาก feedback และควบคุม flow/quality อย่างมีวินัย
