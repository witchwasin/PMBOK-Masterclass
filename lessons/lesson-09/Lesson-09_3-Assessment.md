...
แก่นสำคัญของ Project Cost Management and Earned Value คือข้อใด?

A. ดูเฉพาะเงินที่จ่ายจริงว่าใช้น้อยกว่างบหรือไม่
B. วัดต้นทุนคู่กับมูลค่างานที่ทำเสร็จจริงด้วย cost baseline และ EVM
C. ใช้ management reserve แทน cost control
D. รายงาน CPI อย่างเดียวโดยไม่ดู SPI
