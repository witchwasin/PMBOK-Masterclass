...
- **ควรรู้แล้ว:** WBS, Work Package และ acceptance boundary จาก Lesson 07
- **ยังไม่ต้องรู้:** Cost Baseline หรือ EVM
- **คำศัพท์ใหม่:** Activity, Dependency, Milestone, Critical Path, Float, Schedule Baseline
- **Novice traps:** เริ่มจากวันที่แทน dependency หรือเรียกงานสำคัญทุกงานว่า critical path
...
**[Teaching Scenario]** ERP มี go-live target ก่อน 1 ตุลาคม. Data cleansing ล่าช้าและ data migration ต้องรอ data cleansing กับ configuration เสร็จก่อน.
...
**[Teaching Scenario]** Hotel Booking timeline 8 เดือน มี milestones เช่น payment integration, beta, launch และ post-launch stabilization.
...
**[Professional Opinion]** หลายโครงการมี Gantt chart แต่ไม่มี schedule logic. เมื่อผู้บริหารถามว่า “เลื่อนแค่งานนี้ ทำไมวันจบเลื่อน” PM ตอบไม่ได้ เพราะไม่มี dependency และ critical path. Lesson 08 ต้องทำให้ผู้เรียนใช้ schedule เพื่ออธิบายเหตุและผล ไม่ใช่ใช้เป็นภาพประกอบรายงาน.
...
- **Do:** สร้าง [Activity List, Dependency Network and Master Schedule](learner/Artifact-Template.md)
...
- **Governance:** Scheduler/Leads สร้าง; PM เป็น Owner; Delivery/Vendor/Resource Leads ตรวจ; Steering Committee อนุมัติ
- **Minimum acceptance:** `Usable`
- **Next use:** Lesson 09 ใช้ time-phased activities และ resource needs สร้าง Cost Estimate/Baseline
