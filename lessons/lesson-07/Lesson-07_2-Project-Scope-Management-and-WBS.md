...
- **ควรรู้แล้ว:** Charter Objective และ Stakeholder Needs จาก Lessons 05–06
- **ยังไม่ต้องรู้:** Activity sequencing หรือ duration estimating
- **คำศัพท์ใหม่:** Requirement, Product Scope, Project Scope, WBS, Work Package, Scope Baseline
- **Novice traps:** ใช้คำขอเป็น requirement ทันทีหรือแตก WBS เป็น activity/department
...
**[Teaching Scenario]** ERP Transformation มี 5 modules และ data migration จาก 6 legacy systems. Sales ขอเพิ่ม margin dashboard ก่อน go-live.
...
**[Teaching Scenario]** Hotel Booking MVP มี search, room selection, booking, payment และ back office. Marketing ขอ loyalty points ก่อน launch.
...
**[Professional Opinion]** Scope creep มักเริ่มจากคำว่า “แค่นิดเดียว”. ปัญหาไม่ใช่คำขอหนึ่งข้อ แต่คือไม่มีใครนับผลสะสมของคำขอนั้นใน WBS, schedule, test effort, training และ support. PM ที่ดีทำให้ขอบเขตเป็น visible contract ไม่ใช่ memory ของทีม.
...
- **Do:** สร้าง [Requirements, Scope, WBS and WBS Dictionary](learner/Artifact-Template.md)
...
- **Inputs:** Project Charter and Stakeholder Register
- **Outputs:** Requirements List, Scope Statement, WBS and WBS Dictionary
- **Governance:** BA/PM/Workstream Leads สร้าง; Process Owner/PM เป็น Owner; Business/Architecture/SI ตรวจ; Sponsor/CCB อนุมัติ
- **Minimum acceptance:** `Usable`
- **Next use:** Lesson 08 ใช้ Work Packages, owners และ acceptance criteria สร้าง Activity List/Schedule
