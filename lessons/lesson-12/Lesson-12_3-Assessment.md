...
lesson: 12
sequence: 12.3
title: Project Communications Management — Assessment
...
# Lesson 12_3 — Assessment

## ส่วนที่ 1: Concept Check

### ข้อ 1

แก่นสำคัญของ Project Communications Management คือข้อใด?

A. ส่งอีเมลรายงานให้ครบทุกสัปดาห์
B. ทำให้ข้อมูลที่ถูกต้องไปถึงคนที่ถูกต้องในรูปแบบที่สร้างความเข้าใจและ action
C. จัดประชุมบ่อยที่สุดเท่าที่ทำได้
D. ส่งข้อมูลเดียวกันให้ทุก stakeholder
