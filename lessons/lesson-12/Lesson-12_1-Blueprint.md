...
บทนี้ทำหน้าที่พาผู้เรียนจากภาพรวมในบทก่อนหน้าเข้าสู่ความเข้าใจเชิงลึกของ **Project Communications Management** โดยยังคงแนวทางการสอนแบบ:
...
> **Communication สำเร็จเมื่อผู้รับเข้าใจ ตัดสินใจ หรือดำเนินการได้ ไม่ใช่เมื่อผู้ส่งกด Send**

## 4. Learning Objectives

เมื่อเรียนจบบทนี้ ผู้เรียนควรสามารถ:

1. อธิบายวัตถุประสงค์ของ Project Communications Management
...
- Steering Committee, Project Status, User Communication, Training และ Change Communication
- ออกแบบ Go-live Communication ที่มากกว่าอีเมล
- Escalate Conflict ระหว่าง Finance กับ Warehouse

## 7. Hotel Booking Teaching Focus

- Product Decision, Release Note, Partner Onboarding, Customer Message และ Incident Communication
- ทำให้ Promotion Message ตรงกับ Rule ในระบบ
- สื่อสาร Payment Incident กับ Customer และ Hotel Partner
...
บทนี้ลงลึกเฉพาะ Project Communications Management แต่กล่าวถึง Knowledge Areas อื่นเฉพาะเมื่อจำเป็นต่อการอธิบายผลกระทบข้ามด้าน
