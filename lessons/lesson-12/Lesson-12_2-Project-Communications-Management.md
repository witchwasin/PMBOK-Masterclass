...
**[Scenario]** ERP Transformation มี sponsor คุณสมชาย, PM คุณเอก, TechConsult, 80 key users และหลาย functional managers.
...
**[Scenario]** Hotel Booking Platform มี PO คุณนภา, PM คุณสุทธิ, marketing, product team, hotel partners และ operations.
...
**[Instructor Interpretation]** “ส่งอีเมลแล้ว” ไม่ใช่หลักฐานว่าเกิด communication. หาก message อยู่ท้าย attachment, ไม่มี decision ask, ไม่มี owner และไม่มี feedback loop PM ควรถือว่ายังไม่ได้สื่อสารในเชิงบริหาร.
