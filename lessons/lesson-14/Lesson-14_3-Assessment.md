...
แก่นสำคัญของ Project Procurement Management คือข้อใด?

A. ให้ฝ่ายจัดซื้อรับผิดชอบทุกอย่างหลังออก PO
B. เลือกและควบคุม vendor/contract ให้ส่งมอบ value ตาม acceptance criteria และ risk allocation
