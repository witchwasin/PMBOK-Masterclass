...
บทนี้ทำหน้าที่พาผู้เรียนจากภาพรวมในบทก่อนหน้าเข้าสู่ความเข้าใจเชิงลึกของ **Project Stakeholder Management** โดยยังคงแนวทางการสอนแบบ:
...
> **Stakeholder Management ไม่ใช่การทำให้ทุกคนพอใจ แต่คือการสร้างระดับการมีส่วนร่วมที่เหมาะสมเพื่อให้โครงการเดินหน้า**

## 4. Learning Objectives

เมื่อเรียนจบบทนี้ ผู้เรียนควรสามารถ:

1. อธิบายวัตถุประสงค์ของ Project Stakeholder Management
...
8. Resistance
9. Sponsor Effectiveness
10. Engagement Assessment
11. Stakeholder Communication
12. Conflict and Alignment

## 6. ERP Teaching Focus

- Sponsor, Process Owner, Key User, Data Owner, IT, Vendor, Audit และ Support
- รับมือผู้ใช้ที่ไม่ต้องการเปลี่ยน Process
- จัดการ Functional Manager ที่ไม่ปล่อย Resource ให้ UAT

## 7. Hotel Booking Teaching Focus

- Customer, Hotel Partner, Product Owner, Marketing, Finance, Support และ Payment Provider
- รับมือโรงแรมที่ไม่อัปเดต Inventory
- บริหารความคาดหวังของ Marketing กับ Technical Readiness
...
บทนี้ลงลึกเฉพาะ Project Stakeholder Management แต่กล่าวถึง Knowledge Areas อื่นเฉพาะเมื่อจำเป็นต่อการอธิบายผลกระทบข้ามด้าน
