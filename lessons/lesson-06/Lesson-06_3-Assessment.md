...
แก่นสำคัญของ Project Stakeholder Management คือข้อใด?

A. ทำให้ทุกคนพอใจเท่ากัน
B. ระบุและ engage คนที่มีผลต่อ value ด้วยกลยุทธ์ที่เหมาะกับ power, interest และ impact
C. สื่อสารกับ sponsor เท่านั้น
D. ให้ผู้ใช้เข้าประชุมทุกครั้งโดยไม่ต้องมี decision
