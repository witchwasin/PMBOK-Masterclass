...
lesson: 16
sequence: 16.3
title: Predictive vs Agile vs Hybrid and Tailoring — Assessment
document_type: Assessment
status: Draft
---

# Lesson 16_3 — Assessment

## ส่วนที่ 1: Concept Check

### ข้อ 1

แก่นสำคัญของ Predictive vs Agile vs Hybrid and Tailoring คือข้อใด?

A. เลือก Agile เสมอเพราะทันสมัยกว่า
B. เลือกและ tailor approach ตาม uncertainty, governance, risk, product type และ value feedback
C. ตัด process ที่ไม่อยากทำแล้วเรียกว่า hybrid
D. ใช้ predictive กับทุกโครงการเพื่อควบคุมง่าย
