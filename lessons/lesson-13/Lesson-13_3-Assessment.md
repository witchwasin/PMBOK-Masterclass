...
lesson: 13
sequence: 13.3
title: Project Risk Management — Assessment
...
# Lesson 13_3 — Assessment

## ส่วนที่ 1: Concept Check

### ข้อ 1

แก่นสำคัญของ Project Risk Management คือข้อใด?

A. เขียน risk register ตอนเริ่มโครงการแล้วเก็บไว้
B. ระบุ วิเคราะห์ มอบ owner และติดตาม response ก่อน risk กลายเป็น issue
C. ทำให้ความเสี่ยงเป็นศูนย์ทุกข้อ
D. ให้ PM เป็น owner ของทุก risk
