...
- **ควรรู้แล้ว:** Requirements/WBS, Schedule Gates และ Cost Constraints จาก Lessons 07–09
- **ยังไม่ต้องรู้:** Resource Plan/RACI รายละเอียด
- **คำศัพท์ใหม่:** Quality, Grade, QA, QC, Acceptance Criteria, Test Strategy, Residual Risk
- **Novice traps:** เท่ากับ Quality กับไม่มี defect หรือใช้ Test Pass แทน Business Acceptance
...
**[Teaching Scenario]** ERP ต้องย้ายข้อมูลจาก 6 legacy systems และผ่าน SIT/UAT ก่อน go-live.
...
**[Teaching Scenario]** Hotel Booking ต้องให้ลูกค้าจองและชำระเงินได้เชื่อถือได้ เพื่อเพิ่ม direct booking.
...
**[Professional Opinion]** หลายทีมลด testing เพื่อรักษา deadline แล้วจ่ายแพงหลัง go-live. ปัญหาที่แก้หนึ่งวันใน design อาจกลายเป็น war room หลายสัปดาห์ใน production. Lesson 10 ต้องทำให้ผู้เรียนเห็นว่าคุณภาพเป็น decision ทางธุรกิจ ไม่ใช่ขั้นตอนทางเทคนิคท้ายงาน.
...
- **Do:** สร้าง [Quality Plan, Acceptance Criteria and Test Strategy](learner/Artifact-Template.md)
...
- **Governance:** QA Lead/BA/PM สร้าง; Quality Manager/PM เป็น Owner; Business/IT/SI ตรวจ; Business Owner อนุมัติ
- **Minimum acceptance:** `Usable`
- **Next use:** Lesson 11 ใช้ quality roles, workload และ approval responsibilities สร้าง Resource Plan/RACI
