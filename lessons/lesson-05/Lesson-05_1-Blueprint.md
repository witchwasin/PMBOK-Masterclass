...
บทนี้ทำหน้าที่พาผู้เรียนจากภาพรวมในบทก่อนหน้าเข้าสู่ความเข้าใจเชิงลึกของ **Project Integration Management** โดยยังคงแนวทางการสอนแบบ:
...
> เมื่อ Scope, Schedule, Cost และ Business Value ขัดแย้งกัน ใครต้องเชื่อมข้อมูลและทำให้เกิดการตัดสินใจ?

## 3. Core Teaching Message

> **Integration Management คือการทำให้ทุกส่วนของโครงการเคลื่อนไปในทิศทางเดียวกัน ไม่ใช่แค่การรวมเอกสาร**

## 4. Learning Objectives

เมื่อเรียนจบบทนี้ ผู้เรียนควรสามารถ:

1. อธิบายวัตถุประสงค์ของ Project Integration Management
...
บทนี้ลงลึกเฉพาะ Project Integration Management แต่กล่าวถึง Knowledge Areas อื่นเฉพาะเมื่อจำเป็นต่อการอธิบายผลกระทบข้ามด้าน
