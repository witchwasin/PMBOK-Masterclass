...
เมื่อจบบท ผู้เรียนสามารถ (1) จำแนกงานเป็น project, operation หรือมีทั้งสองส่วนโดยให้เหตุผล, (2) แยก output, outcome, benefit และ business value จากข้อมูลจริง, (3) ระบุ owner ของ outcome หลัง transition, และ (4) เสนอ governance ที่เหมาะกับ functional, matrix หรือ projectized context. `[PMBOK]` `[Best Practice]`

## Mental Model

```text
Business Need → Business Case → Project Work → Output
                                      ↓
Operation / user adoption → Outcome → Benefit → Business Value
```

Project เปลี่ยนสิ่งหนึ่งเพื่อให้ operation สามารถสร้างผลต่อเนื่อง; therefore a delivered output is evidence of progress, not complete evidence of value. `[PMBOK]`
