...
- **ควรรู้แล้ว:** acceptance evidence จาก L10; **คำศัพท์ใหม่:** role, capacity, RACI.
- **Novice trap:** มีชื่อในแผน ไม่ได้แปลว่ามี capacity หรือ authority.
...
**[Teaching Scenario]** ERP Transformation มี 80 key users ที่ต้องทำงานโครงการคู่กับงานประจำใน finance, sales, warehouse, production และ HR.
...
**[Teaching Scenario]** Hotel Booking Platform ใช้ cross-functional team ที่มี UX, frontend, backend, QA, PO และ operations support.
...
**[Enterprise Practice]** หลาย project plan ดูเหมือนมีคนพอเพราะ spreadsheet ใส่ชื่อครบ แต่ในชีวิตจริงคนเดียวกันอยู่ 5 โครงการ, มีงานประจำ, ไม่มี authority หรือไม่มี skill ตรงงาน. Lesson 11 ต้องทำให้ผู้เรียนถามว่า “available จริงไหม” ไม่ใช่ “มีชื่อใน resource plan ไหม”.
...
- **Output:** Consolidated Resource Plan, organization chart and approved RACI.
- **Authority:** PM consolidates; Functional Managers approve commitments; Steering Committee decides exceptions only.
- **Next use:** L12 derives communication audience, cadence and escalation path.
