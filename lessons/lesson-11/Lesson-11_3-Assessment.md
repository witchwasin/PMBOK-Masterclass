...
lesson: 11
sequence: 11.3
title: Project Resource Management — Assessment
document_type: Assessment
status: Draft
---

# Lesson 11_3 — Assessment

## ส่วนที่ 1: Concept Check

### ข้อ 1

แก่นสำคัญของ Project Resource Management คือข้อใด?

A. ใส่ชื่อคนให้ครบใน resource plan
B. ทำให้คน skill capacity authority และ physical resources พร้อมใช้งานตามเวลา
C. เพิ่มคนทุกครั้งเมื่อ schedule delay
D. ให้ทุกคนเป็น Accountable ร่วมกันเพื่อความยืดหยุ่น
