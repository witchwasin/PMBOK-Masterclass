...
| 18 | ทุก Artifact ต้องมี Purpose ไม่ใช่สร้างเพื่อให้ครบ Template | ทั้งเล่ม |
| 19 | เมื่อข้อมูลใหม่เกิดขึ้น ให้ Replan อย่างมี Governance | Ch.7 |
| 20 | PM มีหน้าที่ Integrate ไม่ใช่ทำแทนผู้เชี่ยวชาญทุกคน | ทั้งเล่ม |

## เวอร์ชันย่อ (หัวใจ 5 ข้อ)

```text
1. อย่ารับปากก่อนมี Basis        (Ch.1)
